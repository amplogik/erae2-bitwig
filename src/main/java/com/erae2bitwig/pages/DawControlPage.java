...
/**
 * Page 2: DAW Control — Bitwig-oriented clip launcher.
 *
 * Layout (42×24 surface, origin bottom-left):
 *   y=21-23: Scene launch row (8 scenes across)
 *   y=3-20:  Clip grid (8 scenes × 6 tracks)
 *   y=0-2:   Transport row (play, stop, scroll, record)
 *
